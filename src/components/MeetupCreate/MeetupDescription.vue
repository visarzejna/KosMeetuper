<template>
  <form @input="emitFormData" class="m-b-md">
    <div class="field">
      ...
      <input  @blur="$v.form.image.$touch()" v-model="form.image"
             class="input"
             type="text"
    ...
    <div class="field">
      ...
      <textarea  @blur="$v.form.shortInfo.$touch()" v-model="form.shortInfo"
                class="textarea"
    ...
    <div class="field">
      ...
      <textarea  @blur="$v.form.description.$touch()" v-model="form.description"
                class="textarea"
